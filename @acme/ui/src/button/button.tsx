  ...
  variants: {
    ...
    shape: {
      ...
      icon: [
        ...
        // 'sm:has-[span[class*="sm:not-sr-only"]]:w-auto [&:not(:has(span.sm\\:not-sr-only))]:p-0',
        // 'sm:[&:has(span[class*="sm:not-sr-only"])]:w-auto [&:not(:has(span.sm\\:not-sr-only))]:p-0',
        // "p-[unset]!",
        // 'sm:has-[span[class*="sm:not-sr-only"]]:w-auto has-[span[class*="sm:not-sr-only"]]:p-0 sm:has-[span[class*="sm:not-sr-only"]]:p-[auto]',
